...
class BannerSliderDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $edit = '<a href="'.route('admin.banner-slider.edit', $query->id).
                '" class="btn btn-primary"><i class="fas fa-edit"></i></a>';
                $delete = '<a href="'.route('admin.banner-slider.destroy', $query->id).
                '" class="btn btn-danger ml-2 delete-item"><i class="fas fa-trash"></i></a>';

                return $edit.$delete;
            })->addColumn('banner', function($query){
                return '<img width="80px" height="60px" src="'.asset($query->banner).'">';
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('banner')->width('80px'),
            Column::make('title')->width('200px'),
            Column::make('sub_title')->width('200px'),
            Column::make('status')->width('30px'),
