    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $delete = '<a href="'.route('admin.reservation.destroy', $query->id).
            ...
            ->addColumn('status', function($query){
                $html = '
                <select class="form-control reservation_status" data-id="'.$query->id.'">
                    ...
                    <option '.($query->status === 'cancelled' ? 'selected' : '').' value="cancelled">Cancelled</option>
                </select>';
