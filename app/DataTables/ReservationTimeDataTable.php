...
class ReservationTimeDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $edit = '<a href="'.route('admin.reservation-time.edit', $query->id).
                '" class="btn btn-primary"><i class="fas fa-edit"></i></a>';
                $delete = '<a href="'.route('admin.reservation-time.destroy', $query->id).
    ...
    public function getColumns(): array
    {
        return [
            Column::make('id'),
            Column::make('starting_time'),
            Column::make('stoppage_time'),
            Column::make('status'),
