        ...
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_45">
                    ...
                    <span>
                        <img src="{{ asset('frontend/assetsimages/heading_shapes.png') }}" alt="shapes" class="img-fluid w-100">
                    </span>
        ...
        <div class="row grid">
            @foreach($categories as $category)
                @php
                    ...
                    'show_at_home' => 1, 'status' => 1, 'category_id' => $category->id])
                    ->orderBy('id', 'DESC')
                ...
                @foreach ($products  as $product)
                    <div class="col-md-3 col-sm-6 col-lg-4  {{ $category->slug }}" >
