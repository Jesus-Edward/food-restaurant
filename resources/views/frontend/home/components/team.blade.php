        ...
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_25">
                    <h4>{!! @$sectionTitles['chef_team_top_title'] !!}</h4>
                    <h2>{!! @$sectionTitles['chef_team_main_title'] !!}</h2>
                    <span>
                        <img src="{{ asset('frontend/assets/images/heading_shapes.png') }}" alt="shapes" class="img-fluid w-100">
                    </span>
                    <p>{!! @$sectionTitles['chef_team_sub_title'] !!}</p>
                </div>
            </div>
        </div>

        <div class="row team_slider">
            @foreach($chefTeam as $chef)
                        ...
                        <div class="fp__single_team">
                            ...
                            <div class="fp__single_team_text">
                                ...
                                <ul class="d-flex flex-wrap justify-content-center">
                                    ...
                                    @endif
                                    @if ($chef->x_link)
                                        <li><a href="{{ $chef->x_link }}"><i class="fa-brands fa-x-twitter"></i></a></li>
                                    @endif
                                    @if ($chef->web)
