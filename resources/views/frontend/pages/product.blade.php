        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($products  as $product)
                    <div class="col-md-3 col-sm-6 col-lg-4  wow fadeInUp" data-wow-duration="1s">
                        <div class="fp__menu_item">
                            ...
                            <div class="fp__menu_item_text">
                                ...
                                <ul class="d-flex flex-wrap justify-content-center">
                                    ...
                                    <li><a href="javasvript:;"><i class="far fa-heart"></i></a></li>
                ...
                @endforeach
                @if ($products->isEmpty())
                    <h5 class="text-center mt-5">No Products Found For This Category!</h5>
                @endif
            </div>
