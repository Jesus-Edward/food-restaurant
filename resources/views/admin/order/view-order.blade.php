        ...
        <div class="section-body">
            <div class="invoice">
                                    ...
                                    @foreach ($order->orderItems as $orderItem)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                options: <br>
                                                @foreach ($options as $option)
                                                    {{ @$option->name }}<br> ({{ currencyPosition(@$option->price) }})
                                                @endforeach
                                            </td>
                                        ...
                                        <form action="{{ route('admin.orders.status.update', $order->id) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="payment_status" id="" value>
                                                    ...
                                                    <option @selected($order->payment_status === 'complete') value="completed">Completed
                                                    </option>
                ...
                <div class="text-md-right">
                    ...
                    <button class="btn btn-warning btn-icon icon-left  d-print-none" id="print_btn"><i class="fas fa-print"></i>
                        Print</button>
                </div>
            </div>
        </div>
