              ...
              <div class="accordion">
                ...
                <div class="accordion-body collapse" id="panel-body-1" data-parent="#accordion" style="">
                  <form action="{{ route('admin.daily-offer-title.update') }}" method="POST">
                    ...
                    <input type="text" name="daily_offer_top_title" class="form-control"
                    value="{{ @$titles['daily_offer_top_title'] }}">
                  </div>
                  <div class="form-group">
                    <label for="">Main Title</label>
                    <input type="text" name="daily_offer_main_title" class="form-control"
                     value="{{ @$titles['daily_offer_main_title'] }}">
                  </div>
                  <div class="form-group">
                    <label for="">Sub Title</label>
                    <input type="text" name="daily_offer_sub_title" class="form-control"
