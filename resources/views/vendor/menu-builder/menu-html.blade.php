                                                            ...
                                                            <div class="inside">
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    ...
                                                                    <p id="menu-item-url-wrap">
                                                                        ...
                                                                        <select id="custom-menu-item-pages" class="form-control">
                                                                            ...
                                                                            <option value="Chefs" data-url="/chef">Chef</option>
                                                                            ...
                                                                            <option value="Terms And Conditions" data-url="/terms&cons">Terms And Conditions</option>
                                                                        </select>
                                                                    </p>
                                                                    ...
                                                                    <p id="menu-item-name-wrap">
                                                                        ...
                                                                        <input id="custom-menu-item-name"
                                                                                   ...
                                                                                   class="regular-text form-control text-dark input-with-default-title"
                                                    ...
                                                    <div class="major-publishing-actions">
                                                        <label class="menu-name-label howto open-label" for="menu-name">
                                                            ...
                                                            <input name="menu-name" id="menu-name" type="text"
                                                                   ...
                                                                   title="@lang("menu-builder::messages.enter_menu_name")" readonly
